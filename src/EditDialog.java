...
//        setModal(true);
    ...
    private void resetAction() {
        ...
        switch (type){
            case OBJECT_FROM_DATA:
                editTP.setText(Strings.objectFromObject);
                break;
            case OBJECT_FROM_DATA1:
                System.out.println(Strings.objectFromObject1);
                editTP.setText(Strings.objectFromObject1);
                break;
            case ARRAY_FROM_DATA:
                editTP.setText(Strings.arrayFromData);
                break;
            case ARRAY_FROM_DATA1:
                editTP.setText(Strings.arrayFromData1);
                break;
        }
    }
